var libUrl='../../lib';
    require.config({
        paths:{
            ...
            "bootstrap-table":libUrl+"/bootstrap-table/bootstrap-table",
            "bootstrap-table-zh-CN":libUrl+"/bootstrap-table/bootstrap-table-zh-CN",
            /*datatable*/
        ...
        shim :{//垫片（非AMD模式资源的声明）
            ...
            "bootstrap-table":["jquery",'css!../../lib/bootstrap-table/bootstrap-table'],
            "bootstrap-table-zh-CN":['jquery','bootstrap-table'],
